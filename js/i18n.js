...
const I18N = (function () {
  ...
  const translations = {
    en: {
      ...
      'about.cred4':   '6+ years experience in Costa Rica & International',
      ...
      'form.time.selected':  'Selected time: ',
    ...
    es: {
      ...
      'about.cred4':   '6+ años de experiencia en Costa Rica e Internacional',
      'about.linkedin': 'Perfil de LinkedIn',
      ...
      'form.time.selected': 'Hora seleccionada: ',
